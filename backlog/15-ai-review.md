...
- [x] **AIR-6** — Local Codex command-line helper and explicit Paulitakes Editor skill workflow; end-to-end requested review and human-only apply/publication proof (FR-7.12–7.13). _(deps: AIR-4, AIR-5)_
